    ...
    <td width="25%"  valign="top">
     ...
     <td valign="top" width="85%">
          <p>
            ...
            <br>
              <details>
                <summary>Brief  | <a href="https://github.com/Prithvish04/optimized_bnn_asic">Repository</a> | <a href="https://github.com/Prithvish04/optimized_bnn_asic/blob/main/report.pdf">Report</a>   </summary>            
                <p class="message">
    ...
    <td width="25%"  valign="top">
     ...
     <td valign="top" width="85%">
          <p>
            ...
            <br>
              <details>
                <summary>Brief  | <a href="https://github.com/Prithvish04/multimodel_person_identification/">Repository</a> | <a href="">Report</a> </summary>            
                  <p class="message">
    ...
    <td width="25%"  valign="top">
     ...
     <td valign="top" width="85%">
          <p>
            ...
            <br>
              <details>
              <summary>Brief  | <a href="https://github.com/Prithvish04/WMN_handoff_simulation">Repository</a> | <a href="https://github.com/Prithvish04/WMN_handoff_simulation/blob/main/report.pdf">Report</a> </summary>            
                <p class="message">
